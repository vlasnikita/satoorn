...
const _DEG2RAD = Math.PI / 180,
    ...
    _pathDataToBezier = function(d) {
        let a = (d + "").replace(_scientific, function(m) { let n = +m; return (n < 0.0001 && n > -0.0001) ? 0 : n; }).match(_svgPathExp) || [], //some authoring programs spit out very small numbers in scientific notation like "1e-5", so make sure we round that down to 0 first.
            path = [],
            relativeX = 0,
            relativeY = 0,
            elements = a.length,
